...
TECHNO_IMG = "https://te.legra.ph/file/31e62a4a1730e8aa36d72.jpg"
IMPORTED = {}
MIGRATEABLE = []
HELPABLE = {}
STATS = []
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_photo(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton(text="🤝HELP🤝",
                                                                       ...
                                                                       url="t.me/Itachii_Senpaii")],
                                                                                   [InlineKeyboardButton(text="Add Itachi in your Group",
        ...
        update.effective_message.reply_text("My Sharingan is still protecting your group 👀")
